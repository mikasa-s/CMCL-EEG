...
单数据集微调使用 [preprocess/prepare_ds002336.py](preprocess/prepare_ds002336.py) 或 [preprocess/prepare_ds002739.py](preprocess/prepare_ds002739.py)。
...
- PretrainDatasets：预训练使用哪些数据集，可选 ds002336、ds002739。
